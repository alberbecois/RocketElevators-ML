Rails.application.configure do
  ...
  config.action_mailer.default_url_options = { protocol: 'https', :host => 'www.rocketelevators.me' }
  config.action_controller.forgery_protection_origin_check = false
  # config.session_store :cookie_store, key: '_session_id', secure: true, httponly: true, same_site: :lax
